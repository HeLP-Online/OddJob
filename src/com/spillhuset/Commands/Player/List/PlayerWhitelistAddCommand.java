...
public class PlayerWhitelistAddCommand extends SubCommand {
    @Override
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        OddJob.getInstance().getMessageManager().whitelistAdd(args[2], sender);
    }
    ...
    public List<String> getTab(CommandSender sender, String[] args) {
        ...
        for (UUID uuid : OddJob.getInstance().getPlayerManager().getUUIDs()) {
            ...
            if (!oddPlayer.getName().equals(sender.getName()) || !oddPlayer.isOp() || !oddPlayer.getWhitelist().contains(uuid)) {
                if (args[2].isEmpty()) {
