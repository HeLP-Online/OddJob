...
public class PlayerSetDenyTPACommand extends SubCommand {
    @Override
    ...
    public String getDescription() {
        return "Sets if you are automatically denying teleport request";
    }

    @Override
    public String getSyntax() {
        return "/player set denytpa <true|false>";
    }
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        OddJob.getInstance().getMessageManager().playerSetDenyTPA(deny, sender);
    }
