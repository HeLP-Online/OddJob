    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (strings.length == 1) {
            ...
            if (target == null || !target.isOnline()) {
                OddJob.getInstance().getMessageManager().errorPlayer(Plugin.heal,strings[0],commandSender);
                return true;
            }
        }
        ...
        if (target != null) {
            ...
            if (commandSender instanceof Player && !commandSender.equals(target)) {
                OddJob.getInstance().getMessageManager().healPlayer(target.getName(),commandSender);
            }
