...
public class Arena {
    ...
    private ArenaManager.GameType gameType;
    ...
    public Arena(int id, ArenaManager.GameType gameType) {
        this.id = id;
        this.gameType = gameType;
    }

    public Arena(int id, boolean disabled, int playersLimited, int playersRequired, ArenaManager.GameType gameType, UUID world, Location lobby, int spawnNum, HashMap<String, Location> spawns) {
        this.id = id;
